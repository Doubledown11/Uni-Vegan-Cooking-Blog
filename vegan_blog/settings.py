"""
Django settings for vegan_blog project.
...
SECRET_KEY = 'django-insecure-8_oz4v*6tg0fv!l4h7781!yz==mmuocr=qkfslk(l&64lleiaw'
...
WSGI_APPLICATION = 'vegan_blog.wsgi.application'
